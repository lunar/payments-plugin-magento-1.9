export var LunarCurrencies = {
     ...
     * @return {Number}
     */
    get_lunar_currency_multiplier(currency_iso_code) {
        var currency = this.get_lunar_currency(currency_iso_code);
     ...
     * @returns
     */
    get_lunar_currency(currency_iso_code) {
        var currencies = {
            "AED": {
                    "code": "AED",
