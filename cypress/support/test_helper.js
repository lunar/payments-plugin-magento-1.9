import { LunarCurrencies } from './currencies.js';
...
export let LunarTestHelper = {
     ...
     */
     filterAndGetAmountInMinor($unfilteredAmount, currency) {
        ...
        var multiplier = LunarCurrencies.get_lunar_currency_multiplier(currency);
     ...
     */
     getCurrencyName(currencyCode) {
        var currencyObject = LunarCurrencies.get_lunar_currency(currencyCode);
