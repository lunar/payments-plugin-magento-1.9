...
class Lunar_Data_Currencies
{
	 ...
	 * @return int|number
	 */
	public function getLunarMultiplier( $currency_iso_code ) {
	 ...
	 * @return int|number
	 */
	private function getLunarDivider( $currency_iso_code ) {
		return $this->getLunarMultiplier( $currency_iso_code );
	}
	...
	public function ceil( $amount, $currencyCode ) {
		...
		return ceil( round( $amount, 3 ) * $this->getLunarMultiplier( $currencyCode ) );
	}
