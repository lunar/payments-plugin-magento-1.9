 ...
 * @package Lunar\Utils
 */
class Lunar_Utils_Cursor implements Iterator, Countable, ArrayAccess
{
     ...
     * @param array $params
     * @param array $data
     * @param Lunar_Lunar $lunar
     * @throws Exception
     */
    public function __construct($endpoint, array $params, array $data, Lunar_Lunar $lunar)
    {
